...
int circuit_stream_is_being_handled(entry_connection_t *conn, uint16_t port,
                                    int min);
int circuit_stream_is_being_handled_Mohsen(float lat, float lon, int min);//Mohsen
circuit_t * circuit_get_by_id(circid_t id);//Mohsen
#if 0
...
origin_circuit_t *circuit_launch_by_extend_info_Mohsen(uint8_t purpose,
                                                extend_info_t *info,
                                                int flags, float lat, float lon,float Mylat, float Mylon);//Mohsen
origin_circuit_t *circuit_launch_Mohsen(uint8_t purpose, int flags, float lat, float lon, float Mylat, float Mylon);//Mohsen
