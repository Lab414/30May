 ...
 */
// Mohsen: 4 Feb-------------------------------
extern float MINGAIN ;
extern float MAX_BETA;
extern float BETA;
extern float P_PARAM;
extern float ALPHA_MOHSEN;
extern float LAMBDA;
extern int MIN_NUMBER_OF_CIRC_FOR_EACH_DEST;
//-----------------------------------
